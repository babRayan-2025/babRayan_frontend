    ...
    return (
        ...
        <div class="grid md:grid-cols-3 items-center shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-xl overflow-hidden">
          ...
          <form class="md:col-span-2 w-full py-6 px-6 sm:px-16">
            ...
            <div class="space-y-6">
              ...
              <div class="flex items-center">
                ...
                <label for="remember-me" class="ml-3 block text-sm text-gray-800">
                  I accept the <Link href="javascript:void(0);" class="text-blue-600 font-semibold hover:underline ml-1">Terms and Conditions</Link>
                </label>
              </div>
            </div>
            ...
            <p class="text-gray-800 text-sm mt-6 text-center">Already have an account? <Link href="/login" class="text-blue-600 font-semibold hover:underline ml-1">Login here</Link></p>
          </form>
        </div>
      </div>
    );
