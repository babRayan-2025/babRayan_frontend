            ...
            <section className="max-w-3xl mx-auto bg-white shadow-lg rounded-2xl p-4 md:p-8 border border-[#0d0d0d] mt-2 ">
                ...
                >
                     <div className="flex items-center justify-center flex-wrap px-2">
                      <h1 className="text-xl md:text-3xl font-bold text-center text-[#d32a2a] mr-1">Votre générosité transforme des vies.</h1>
                       <img
                    ...
                    <h1 className="text-xl md:text-3xl font-bold text-center text-[#d32a2a] mb-4">Grâce à vous :</h1>
                    <ul className="list-none font-semibold text-[#1d1d1d] text-lg md:text-xl ml-5 mb-8" style={{ lineHeight: "1.2" }}>
                   ...
                   <p className="text-center text-[#cc2229] italic text-xl md:text-3xl font-bold mt-2 md:mt-4 leading-normal">
                        “ Parce que chaque enfant <br className="md:hidden"/> mérite un bon départ dans la vie ”
                    </p>
                </motion.div>
            </section>
