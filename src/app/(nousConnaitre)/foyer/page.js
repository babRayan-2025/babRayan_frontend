...
export default function Foyer() {
    ...
    return (
        <section>
                        ...
                        return (
                            ...
                            >
                                <div>
                                    <Image
                                        src={card.image}
                                        style={{ width: "470px", height: "400px", objectFit: "cover" }}
            ...
            {/* ACTIVITÉS section */}
            <div className="flex flex-col items-center pt-16 pb-16" style={{ backgroundColor: "#FFD9DA" }}>
                ...
                <div className="flex items-center justify-center w-full gap-8 p-8 rounded-lg">
                    ...
                    <div className="w-1/3 text-gray-800">
                        <p className="text-justify leading-relaxed">
                            Le choix d’une activité dans un club de leur préférence constitue une étape
                            essentielle du processus éducatif. Cette initiative offre aux adolescents
                            l’opportunité de s’investir dans une activité qui les passionne, favorisant ainsi
                            leur épanouissement personnel. Qu’il s’agisse de Rugby, Football, Tennis,
                            Basketball, Équitation...
                            <br /><br />
                            En rejoignant un club aligné sur leurs centres d’intérêt, ils développent des
                            compétences spécifiques, renforcent leur estime de soi et posent
                            progressivement les bases solides de leur future autonomie. Cette démarche
                            permet également de concrétiser, dans leur quotidien, les idées et objectifs
                            qu’ils se fixent pour construire leur projet de vie.
                        </p>
                    </div>
                </div>
