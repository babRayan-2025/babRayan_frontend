  ...
  return (
      <section>
        <div className="py-5 d-flex justify-content-between align-items-center">
          ...
          <Link className='btn btn_add' href="/dashboard/news/add">Ajouter un nouvel article</Link>
          ...
          <tbody>
            {currentActualites.map(actualite => (
              <tr key={actualite.id}>
                ...
                <td>
                  <button onClick={() => handleEdit(actualite)} type="button" className="btn btn_edit">
                    <span><i className="fa-solid fa-pen-to-square"></i></span>
                  </button>
                  <button onClick={() => handleDelete(actualite.id)} type="button" className="btn btn_delete">
