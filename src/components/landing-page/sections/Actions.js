  ...
  const actions = [
    {
      ...
      desc: `l’Association Bab Rayan donne à ses jeunes la chance de découvrir le monde fascinant de la culture et de l’art. À travers ... `
    //   le programme de l’école du jeune spectateur, de nombreuses sorties au théâtre sont organisées, offrant aux enfants et adolescents une immersion unique dans l’univers des arts vivants.<br />
     ...
     },
    {
      ...
      desc: `Aujourd’hui, plusieurs projets de l’association Bab Rayan intègrent la digitalisation comme levier d’apprentissage ...`
    //    et d’insertion professionnelle. À l’école élémentaire, nous sensibilisons dès le plus jeune âge à l’informatique à travers des programmes de codage interactifs, spécialement conçus pour éveiller l’intérêt des enfants pour les métiers de l’IT.<br />
    ...
    },
    {
      ...
      desc: `Créé pour répondre aux besoins croissants du marché digital, ForsaTech propose des formations accélérées aux jeunes ...`
    //    en difficulté, axées sur les compétences numériques les plus demandées. Conçu en collaboration avec des entreprises partenaires, ce programme garantit une employabilité directe grâce à une sélection rigoureuse des modules et des candidats.<br />
    ...
    <section className='actions mt-5'>
      ...
      <div className="mt-4 row w-75 d-flex justify-content-center m-auto ">
        ...
        <div className="text-center fw-bold">
          <h3>
            <i style={{textShadow : "0 0 5px #002f49b2"}}>Notre Impact</i>
          </h3>
        </div>
